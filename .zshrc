...
alias hr="gh repo"
alias hrc="func() { mkdir -p $(echo '$1') && cd $(echo '$1') && git init && gh repo create $(echo '$1') --private $(echo '${@:2}') && git branch -M main && git remote add origin git@github.com:$(echo '$1').git; }; func"
alias hrcd="func() { mkdir -p $(echo '$1') && cd $(echo '$1') && git init && gh repo create $(echo '$1') --private --description \"$(echo '${*# }')\" && git branch -M main && git remote add origin git@github.com:$(echo '$1').git; }; func"
alias hrci="func() { mkdir -p $(echo '$1') &&  cd $(echo '$1') &&  git init && gh repo create $(echo '$1') --internal $(echo '${@:2}') && git branch -M main && git remote add origin git@github.com:$(echo '$1').git; }; func"
alias hrcid="func() { mkdir -p $(echo '$1') && cd $(echo '$1') &&  git init && gh repo create $(echo '$1') --internal --description \"$(echo '${*# }')\" && git branch -M main && git remote add origin git@github.com:$(echo '$1').git; }; func"
alias hrcp="func() { mkdir -p $(echo '$1') && cd $(echo '$1') && git init && gh repo create $(echo '$1') --public $(echo '${@:2}') && git branch -M main && git remote add origin git@github.com:$(echo '$1').git; }; func"
alias hrcpd="func() { mkdir -p $(echo '$1') && cd $(echo '$1') && git init && gh repo create $(echo '$1') --public --description \"$(echo '${*# }')\" && git branch -M main && git remote add origin git@github.com:$(echo '$1').git; }; func"
...
alias qp="func() { quarto publish --no-prompt --no-browser gh-pages; git add --all && git commit --message \"$(echo '${*:-Changed files: $(echo $(git status --porcelain | grep -v "?" | cut -c4- | tr "\n" " "))}')\" && git push; }; func"
