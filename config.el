...
(setq doom-font (font-spec :family "Ewka Nerd Font" :size 24)
      doom-big-font (font-spec :family "Ewka Nerd Font" :size 32))
...
(define-key evil-ex-completion-map "\C-w" 'evil-delete-backward-word)
