...
ln -sf ~/maptv/setup/settings.json ~/Library/Application\ Support/Kiro/User/settings.json
ln -sf ~/maptv/setup/keybindings.json ~/Library/Application\ Support/Code/User/keybindings.json
...
ln -sf ~/maptv/setup/keybindings.json ~/Library/Application\ Support/Kiro/User/keybindings.json
