...
"$HOMEBREW_PREFIX"/bin/code --install-extension eamodio.gitlens
"$HOMEBREW_PREFIX"/bin/code --install-extension vscodevim.vim
"$HOMEBREW_PREFIX"/bin/code --disable-extension vscodevim.vim
"$HOMEBREW_PREFIX"/bin/code --install-extension jonsmithers.open-in-vim
